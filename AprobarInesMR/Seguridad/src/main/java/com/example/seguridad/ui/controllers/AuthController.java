...
public class AuthController {
    ...
    public AuthenticationResponse loginAuth(@RequestParam(Constantes.REQUEST_PARAM_USERNAME) String username, @RequestParam(Constantes.REQUEST_PARAM_PASSWORD) String password) {
