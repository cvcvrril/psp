...
public class ConstantsDao {
    ...
    public static final String IDFACCIONES = "idfacciones";
    public static final String NOMBRE_FACCION = "nombre_faccion";
    public static final String ID = "id";
    public static final String NOMBRE_RAZA = "nombre_raza";
    public static final String PLANETA_ORIGEN = "planeta_origen";
